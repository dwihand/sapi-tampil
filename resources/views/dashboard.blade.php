...
<div class="row">
    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
        <div class="card-box tilebox-one">
            ...
            <h6 class="text-muted text-uppercase mb-3">Data Jumlah Sapi</h6>
            <h4 class="mb-3"><span data-plugin="counterup">{{$count_sapi}} </span></h4>
    ...
    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
        <div class="card-box tilebox-one">
            ...
            <span class="badge badge-primary"> Rupiah</span> 
        </div>
    </div>
