        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                              <label for="">Penghasilan Susu (C1)  </label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                              <label for="">WEIGHT Konsumsi Pakan (C2)  </label>
                        ...
                        <div class="form-group">
                              ...
                              <select name="w_c4" id="" class="form-control">
                                <option value="0.2" @if ($c44->weight == 0.2)
                                    {{ "selected" }} @endif >Sangat Kurang Sehat </option>
                                <option value="0.4" @if ($c44->weight == 0.4)
                                  {{ "selected" }} @endif>Kurang Sehat </option>
                                <option value="0.6" @if ($c44->weight == 0.6)
                                  {{ "selected" }} @endif>Sehat </option>
                                <option value="0.8" @if ($c44->weight == 0.8)
                                  {{ "selected" }} @endif>Cukup Sehat </option>
                                <option value="1" @if ($c44->weight == 1)
                                  {{ "selected" }} @endif>Sangat Sehat </option>
                            </select>
                        </div>
